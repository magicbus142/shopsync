             ...
             <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                        ...
                        {shop.plan_key === 'free' ? 'Free Experience' : 'Smart Shop'}
                    </span>
                ...
                <div className="bg-card border border-border rounded-xl overflow-hidden">
                   <div className={`p-4 border-b border-border flex items-center justify-between ${shop.plan_key !== 'free' ? 'bg-blue-50/50 dark:bg-blue-900/10' : ''}`}>
                      <div className="flex items-center gap-2">
                         ...
                         <span className="font-medium">{shop.plan_key === 'free' ? 'Free Plan' : 'Smart Shop Plan'}</span>
                      </div>
                   ...
                   <div className="p-4 bg-muted/20">
                      ...
                      <div className="flex gap-2">
                         ...
                         <button 
                           onClick={() => onUpdatePlan(shop.org_id, 'smart_shop')}
                           disabled={shop.plan_key === 'smart_shop'}
                           className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                             shop.plan_key === 'smart_shop' 
