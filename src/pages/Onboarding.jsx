          ...
          {step === 3 && (
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-muted-foreground">Choose what you need. You can change this later.</p>
              </div>
              
              <div className="space-y-3 mb-6">
                {[
                  { id: 'inventory', label: 'Inventory Management', desc: 'Track stock and products' },
                  { id: 'workers', label: 'Worker Management', desc: 'Manage staff and permissions' },
                  { id: 'transactions', label: 'Transactions', desc: 'Record sales and expenses' },
                  { id: 'reports', label: 'Reports & Analytics', desc: 'View insights and charts' }
                ].map(feature => (
                  <div 
                    key={feature.id}
                  ...
                  >
                    <div className={`mt-0.5 w-5 h-5 rounded border flex items-center justify-center ${
                         formData.features.includes(feature.id) ? 'bg-primary border-primary text-primary-foreground' : 'border-muted-foreground'
                    }`}>
                        {formData.features.includes(feature.id) && <CheckCircle2 className="w-3.5 h-3.5" />}
                    </div>
                    <div>
              ...
              <div className="flex gap-3">
                  ...
                  <button 
                    onClick={() => setStep(4)}
                    className="flex-1 py-3 bg-primary text-primary-foreground rounded-xl font-semibold hover:bg-primary/90"
                  >
                    Continue
                  </button>
                </div>
